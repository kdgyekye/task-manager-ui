            ...
            <nav className="navbar navbar-expand-sm navbar-default">
                <div id="main-menu" className="main-menu collapse navbar-collapse">
                    <ul className="nav navbar-nav">
                        <li className={`${'/' === useLocation().pathname? 'active-link': ''}`}>
                            <Link to="/"><i className="menu-icon fa fa-laptop"/>Dashboard </Link>
                        </li>
                        <li className="menu-title">COLLECTIONS</li>
                        <li className={`menu-item-has-children dropdown ${'/tasks' === useLocation().pathname?'active-link': ''}`}>
                        ...
                        <li className={`menu-item-has-children dropdown ${'/categories' === useLocation().pathname?'active-link': ''}`}>
                        ...
                        <li className={`menu-item-has-children dropdown ${'/add-task' === useLocation().pathname?'active-link': ''}`}>
                        ...
                        <li className={`menu-item-has-children dropdown ${'/add-category' === useLocation().pathname?'active-link': ''}`}>
